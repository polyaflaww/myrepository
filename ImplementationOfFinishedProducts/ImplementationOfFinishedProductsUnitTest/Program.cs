using System;
using ImplementationOfFinishedProducts;
using NUnit.Framework;

namespace ImplementationOfFinisedProductsUnitTest
{
    class Program
    {
        [Test]
        ...
        {
            return new Commodity(123456, "Стул деревянный", 20000, 40000, TypeOfUnit.Number, "Стул из красного дерева, выполненный в Италии", 43);
        }
    }
}